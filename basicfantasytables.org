...
** All Spells, in Alphabetical Order Tables
*** Confusion Spell Table
Confusion Spell Table:
...
*** Gems And Jewelry (Base Value In Gold Pieces And Number Found) Table
Gems And Jewelry (Base Value In Gold Pieces And Number Found) Table:
...
*** Gems And Jewelry (Value Adjustment) Table
Gems And Jewelry (Value Adjustment) Table:
...
*** Gems And Jewelry (Gem Type) Table
Gems And Jewelry (Gem Type) Table:
...
** Dungeon Encounters Monsters Table (Level 1 To 3)
Dungeon Encounters Monsters Table (Level 1 To 3):
...
** Dungeon Encounters Monsters Table (Level 4 To 8+)
Dungeon Encounters Monsters Table (Level 4 To 8+):
...
** Wilderness Encounters Monsters Table (Desert Or Barren, Grassland, Or Inhabited Territories)
Wilderness Encounters Monsters Table (Desert Or Barren, Grassland, Or Inhabited Territories):
...
** Wilderness Encounters Monsters Table (Jungle, Mountain Or Hills, Ocean)
Wilderness Encounters Monsters Table (Jungle, Mountain Or Hills, Ocean):
...
** Wilderness Encounters Monsters Table (River Or Riverside, Swamp, Woods Or Forest)
Wilderness Encounters Monsters Table (River Or Riverside, Swamp, Woods Or Forest):
